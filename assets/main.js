...
var curIsotopePage = '';
var ppp = 12; /*Set number of items in portfolio*/
...
jQuery(document).ready(function() {
	...
	jQuery('#page:not(.print) .resume-content-section .section-header').click(function(){
...
function skills_anim(){
	if(!jQuery('#page').hasClass('print')) {
		if(jQuery('.resume-content-section .widgets_section.section-header:visible').length > 0) {
			var wnd = jQuery(window).scrollTop()+jQuery(window).height();
			var oft = jQuery('.resume-content-section:visible .widgets_section.section-header').offset().top+
